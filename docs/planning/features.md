...
- **노래방 모드 (Karaoke Mode)**:
  - 유튜브 영상 위에 가사(미니 뷰어 등)와 재생 제어바를 오버레이하여 몰입감을 높입니다.
  - 유튜브 본연의 컨트롤러와 자막을 대체합니다.
  - 전체화면 전환 시에도 가사, 발음, 해석이 영상과 함께 표시됩니다.
  - 전체화면에서 가사 창의 크기를 비율(%)로 조절하여 영상 가림을 최소화하거나 가독성을 높일 수 있습니다.
