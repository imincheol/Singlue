...
export default function HomePage() {
    ...
    return (
        <div className="flex-1 flex flex-col w-full relative">
            {/* Hero Section */}
            <section className="flex flex-col items-center justify-center space-y-8 animate-in fade-in zoom-in duration-500 min-h-[75vh] w-full py-12">
                ...
                <form onSubmit={handleSearch} className="w-full max-w-xl relative group px-4">
                    ...
                    <div className="relative flex items-center bg-zinc-100 dark:bg-zinc-900 border border-zinc-300 dark:border-zinc-700 rounded-full p-2 pl-6 shadow-2xl has-[:focus]:border-indigo-500 transition-colors">
                        ...
                        <button
                            type="submit"
                            className="bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-2 rounded-full font-medium transition-colors whitespace-nowrap"
                        >
                            {t('home.start')}
                        </button>
                    </div>
                    {error && (
                        <div className="mt-4 text-red-500 text-sm font-medium animate-in fade-in slide-in-from-top-1 duration-200 px-4">
                            {error}
                        </div>
                    )}
                </form>
            ...
            {recentSongs.length > 0 && (
                <section className="w-full flex justify-center pb-20 bg-gradient-to-b from-transparent to-zinc-50/50 dark:to-zinc-900/50">
                    <div className="w-full max-w-7xl px-4 animate-in fade-in slide-in-from-bottom-5 duration-700 delay-200">
